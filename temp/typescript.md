...
It just works like a charm without any settings. But if you need to customize the setup [options](/getting-started#vfmplugin), you can define the type like below:
