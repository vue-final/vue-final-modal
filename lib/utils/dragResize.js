...
export const getBoundingRect = (vfmContainer, vfmContent) => {
  return {
    rectContainer: vfmContainer.getBoundingClientRect(),
    rectContent: vfmContent.getBoundingClientRect()
  }
}

export const getLimit = (rectContainer, vfmWrapper, rectContent) => {
  return {
